...
public class EmployerServiceTest {
  ...
  private Status status = new VacationStatus("accepted", "pending", "reject");
  ...
  public void getPendingVacations() {
    ...
    vacationResponseDtos.add(VacationResponseDto.newBuilder()
            ...
            .dateFrom(999999999999999999L)
            .dateTo(999999999999999999L)
            .vacationId(1L)
            .status("pending")
            .description("some")
            .build());
  ...
  private void addRequestVacation() {
    ...
    EmployeeService service = new EmployeeService(repository, currentDate);
    FakeRequest fakeRequest = new FakeRequest();

    fakeRequest.dto = VacationRequestDto.newBuilder()
            .userId("gosho@gmail.com")
            .fromDate(999999999999999999L)
            .toDate(999999999999999999L)
            .description("some")
            .build();
