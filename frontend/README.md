...
```sh
$ git clone git://github.com/clouway/clouway-hr
$ cd frontend
...
`frontend` also includes [Live Reload](http://livereload.com/), so you no
...
default with `frontend`) you need to tell Live Reload to allow it. Go to
